 ...
 * Annonce
 *
 * @ORM\Table(name="annonce", indexes={@ORM\Index(name="FK_TypeAnnonce", columns={"idTypeA"}), @ORM\Index(name="FK_EquideAnnonce", columns={"idEquideA"}), @ORM\Index(name="FK_UtilisateurAnnonce", columns={"idUtilisateurAnnonce"})})
 * @ORM\Entity
 */
class Annonce
{
